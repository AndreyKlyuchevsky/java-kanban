...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task task1 = new Task("Первая задача","очень важная первая задача","NEW");
        Task task2 = new Task("Вторая задача","оычень важная вторая задача","DONE");
        ...
        Subtask subtask1 = new Subtask("Первая подзадача","очень важная первая подзадача 1 Epic", "NEW",epic1.getId());
        Subtask subtask2 = new Subtask("Вторая подзадача","очень важная вторая подзадача 1 Epic","NEW",epic1.getId());
        Subtask subtask3 = new Subtask("Первая подзадача","оычень важная вторая подзадача 2 Epic","NEW",epic2.getId());
        ...
        Subtask subtask4 = new Subtask("Первая подзадача","очень важная первая подзадача 1 Epic", "Done",epic1.getId());
        manager.updateSubtask(subtask4,subtask1.getId());
        System.out.println(manager.getId(epic1.getId()));
        //печатаем все задачи
